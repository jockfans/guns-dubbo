...
public class EntityGenerator {
    ...
    public void entityGenerator() {
        ...
        gc.setOutputDir("/Users/misdeadgirl/IdeaProjects/guns/guns-gateway/src/main/java");//这里写你自己的java目录
        ...
        strategy.setInclude(new String[]{"mooc_user_t"});//此处的表名必须先在数据库中建表
